...
const sessionData = JSON.stringify({
  session_key: bytesToHex(crypto.getRandomValues(new Uint8Array(32))),
  job_id: "12345",
...
```json
{
  "session_key": "0x...",            // 32-byte session key (generated by client, hex-encoded)
...
export class EncryptedSession {
  ...
  async init(jobId: number, modelName: string, pricePerToken: string): Promise<void> {
    ...
    const sessionData = JSON.stringify({
      session_key: this.bytesToHex(this.sessionKey),
