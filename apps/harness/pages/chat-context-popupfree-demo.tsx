...
// Production node #2 uses TEST_USER_2 as the host (not TEST_HOST_2)
const TEST_HOST_2_ADDRESS = process.env.NEXT_PUBLIC_TEST_USER_2_ADDRESS!;
const TEST_HOST_2_PRIVATE_KEY =
  process.env.NEXT_PUBLIC_TEST_USER_2_PRIVATE_KEY!;
